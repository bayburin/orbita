...
import { ComponentFixture, TestBed, inject, tick, fakeAsync, flush, waitForAsync } from '@angular/core/testing';
...
describe('UserDashboardMenuComponent', () => {
  ...
  describe('#loadNewNotifications', () => {
    ...
    const mockNewNotifications = NotifyFactory.create({
      id: 6,
      body: { message: 'Hello Notify 3' },
      event_type: 'claim',
    });
    let spy: jasmine.Spy;
  ...
  describe('#shallow tests', () => {
    ...
    beforeEach(() => {
      ...
      spyOn(notifyService, 'loadNotifications').and.returnValues(
        of(mockNotifications),
        of(mockNotifications.concat(mockNewNotification))
      );
