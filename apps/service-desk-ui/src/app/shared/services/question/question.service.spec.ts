...
describe('QuestionService', () => {
  ...
  describe('#raiseRating', () => {
    const question = TicketFactory.create(TicketTypes.QUESTION, {
      id: 1,
      ticket: { id: 2, service_id: 2, popularity: 1 },
    });
  ...
  describe('#updateTicket', () => {
    ...
    beforeEach(() => {
      ...
      questionI = {
        id: 2,
        ticket: { name: 'Тестовый вопрос', service_id: 1, responsible_users: responsibleUsers },
      } as QuestionI;
  ...
  describe('#removeDraftQuestion', () => {
    ...
    beforeEach(() => {
      ...
      questionService.draftQuestions = questionsI.map((questionI) =>
