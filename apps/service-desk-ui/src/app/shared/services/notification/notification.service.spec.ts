...
describe('NotificationService', () => {
  ...
  describe('#loadNewNotifications', () => {
    ...
    it('should set zero in "value" attribute of notificationCount object', inject(
      [APP_CONFIG],
      (config: AppConfigI) => {
        const notificationsUrl = `${environment.serverUrl}/api/v1/users/new_notifications?limit=${config.defaultUserDashboardListCount}`;
  ...
  describe('#toggleNotificationLimit', () => {
    it('should set max value in "value" attribute of notificationCount object if had been set default value', inject(
      [APP_CONFIG],
      (config: AppConfigI) => {
    ...
    it('should set default value in "value" attribute of notificationCount object if had been set max value', inject(
      [APP_CONFIG],
      (config: AppConfigI) => {
        notifyService.toggleNotificationLimit();
        notifyService.toggleNotificationLimit();
  ...
  describe('#setDefaultNotificationLimit', () => {
    it('should set default value in "value" attribute of notificationCount object', inject(
      [APP_CONFIG],
      (config: AppConfigI) => {
        notifyService.toggleNotificationLimit();
