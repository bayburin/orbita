...
describe('BreadcrumbComponent', () => {
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        imports: [RouterTestingModule.withRoutes(routes), TicketModule, HttpClientTestingModule, NoopAnimationsModule],
        providers: [
  ...
  describe('after component init', () => {
    ...
    it('should retirect to dashboard page', fakeAsync(
    ...
    it('should redirect to the categories page', fakeAsync(
      inject([Location], (location: Location) => {
        router.navigateByUrl('/categories/1/services/2');
        tick();
        fixture.detectChanges();
