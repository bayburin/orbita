  ...
  describe('Command buttons', () => {
    ...
    describe('#bold', () => {
      ...
      it('should call #format method for markdown instance', () => {
        expect((component as any).markdown.format).toHaveBeenCalledWith(
    ...
    describe('#empty_line', () => {
      ...
      it('should call #format method for markdown instance', () => {
        expect((component as any).markdown.format).toHaveBeenCalledWith(jasmine.any(SimpleTextFormatter), `<br>`, {
          defaultText: '',
        });
      });
