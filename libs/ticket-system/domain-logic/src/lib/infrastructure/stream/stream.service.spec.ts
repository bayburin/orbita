...
import { ORBITA_UI_ENV_TOKEN, OrbitaUiEnvironment, orbitaUiEnvironmentStub } from '@orbita/shared/environment';
...
describe('StreamService', () => {
  ...
  it('should sets access token into channelServer variable', () => {
    expect(service.cable.params).toEqual({ access_token: authHelper.getRawJwt() });
  });
});
