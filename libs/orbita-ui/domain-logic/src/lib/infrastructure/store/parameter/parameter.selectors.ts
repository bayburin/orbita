...
import {
  PARAMETER_FEATURE_KEY,
  State,
  ParameterPartialState,
  parameterAdapter,
...
export const getAll = createSelector(getParameterState, (state: State) =>
  selectAll(state)
);

export const getEntities = createSelector(getParameterState, (state: State) =>
