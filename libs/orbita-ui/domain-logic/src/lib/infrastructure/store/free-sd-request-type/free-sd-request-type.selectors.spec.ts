...
describe('FreeSdRequestTypeSelectors', () => {
  ...
  beforeEach(() => {
    state = freeSdRequestTypeAdapter.setAll(arrEntities, {
      ...initialState,
  ...
  it('getAll() should return array of entities', () => {
    expect(FreeSdRequestTypeSelectors.getAll.projector(state)).toEqual(
      arrEntities
    );
  });

  it('getEntities() should return entities', () => {
    expect(FreeSdRequestTypeSelectors.getEntities.projector(state)).toEqual(
      entities
    );
  });

  it('getSelectedId() should return "selectedId" attribute', () => {
    expect(FreeSdRequestTypeSelectors.getSelectedId.projector(state)).toEqual(
      selectedId
    );
  });
  ...
  it('getSelected() should return selected entity', () => {
    expect(
      FreeSdRequestTypeSelectors.getSelected.projector(entities, selectedId)
